    ...
    return (
        <Features color="194,97,254" colorDark="53,42,79">
            <Features.Main
                ...
                text="Create tasks in seconds, discuss issues in context, and breeze through your work in views and tailored to you and your team."
                image="/issues.webp"
            />
            <Features.Grid
                features={[
